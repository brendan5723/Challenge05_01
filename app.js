...
//app.get("/", function (req, res) {
 //   let toy = { name: "snot", toy_type: "puppet", colour: "pink and white" };
    // res.send(`<h2>My Toys</h2><p>My toy is called ${toy.name}  and it's a ${toy.toy_type}.`);
  //  res.render('index', {mydata: toy});
//});
...
//this code sets up a web server that listens for requests on port 3000 
//and responds with a message about a toy when the URL is accessed.
